...
TOTAL_TIME= $($START_TIME-$END_TIME) # Give double brackets other wise "$() the text inside the brackets will be treated as command so we have to give double brackets"
